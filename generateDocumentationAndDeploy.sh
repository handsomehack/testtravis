...
echo '<meta http-equiv="refresh" content="2;url=https://maxbarber.github.io/2020_GROUP_6/html/index.html/">' >> index.html
echo '</head>' >> index.html
echo '<body>' >>index.html
echo 'This is the old page that will redirect to the new one' >> index.html
echo '</body>' >>index.html
echo '</html>' >>index.html
